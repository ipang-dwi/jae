		  ...
		  <div class="panel-heading">Edit Data Alternatif Calon Karyawan</div>
						<?php
									...
									while($alt = $result->fetch_assoc()){
										$a[0] = $alt['alternatif'];
										$a[5] = $alt['tempat_lahir'];
										$a[6] = $alt['tanggal_lahir'];
										$a[1] = $alt['k1'];
										$a[2] = $alt['k2'];
										$a[3] = $alt['k3'];
										$a[4] = $alt['k4'];
                                    ...
                                    <div class="box-body">
                                       <?php
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="alternatif" id="alternatif" placeholder="Nama Calon Karyawan" value="<?php echo $a[0]?>">
                                        </div>
										<div class="form-group">
                                            <label for="tempat">Tempat Lahir</label>
                                            <input type="text" class="form-control" name="tempat" id="tempat" placeholder="Tempat Lahir" value="<?php echo $a[5]?>" required >
                                        </div>
										<div class="form-group">
										   <label for="alternatif">Tanggal Lahir</label>
										   <div id="filterDate2">
          
										  <!-- Datepicker as text field -->         
										  <div class="input-group date" data-date-format="yyyy-mm-dd">
                                           <input type="text" class="form-control" name="tanggal" id="datepicker" placeholder="yyyy-mm-dd" value="<?php echo $a[6]?>" required >
                                        ...
                                        <div class="form-group">
											...
											?>
												<option value='<?php echo $row["skor"];?>' <?php if($a[1]==$row["skor"]) echo "selected"?>><?php echo $row["sub_kriteria"];?></option>
										    <?php
												}
											?>
											</select>
										...
										<div class="form-group">
											...
											<?php 
												...
												while ($row = $subkriteria->fetch_assoc()) {
											?>
												<option value='<?php echo $row["skor"];?>' <?php if($a[2]==$row["skor"]) echo "selected"?>><?php echo $row["sub_kriteria"];?></option>
										    <?php
												}
											?>
											</select>
										...
										<div class="form-group">
											...
											<?php 
												...
												while ($row = $subkriteria->fetch_assoc()) {
											?>
												<option value='<?php echo $row["skor"];?>' <?php if($a[3]==$row["skor"]) echo "selected"?>><?php echo $row["sub_kriteria"];?></option>
										    <?php
												}
											?>
											</select>
										...
										<div class="form-group">
											...
											<?php 
												...
												while ($row = $subkriteria->fetch_assoc()) {
											?>
												<option value='<?php echo $row["skor"];?>' <?php if($a[4]==$row["skor"]) echo "selected"?>><?php echo $row["sub_kriteria"];?></option>
										    <?php
												}
											?>
											</select>
